...
--
-- Хост: 127.0.0.1
-- Время создания: Май 24 2016 г., 12:19
...
(1, 'Луганск ЦОПП', 'ул. Виктора Пятеркина, 8', 'Луганск', 0),
...
--
ALTER TABLE `centerspost`
  MODIFY `idcenterspost` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT для таблицы `distancesmatrix`
--
ALTER TABLE `distancesmatrix`
  MODIFY `idistancesmatrix` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=170;
--
